...
# 可选覆盖：OPENAI_BASE_URL(默认 http://localhost:8080/v1)、EMBED_MODEL、EMBED_DIM(默认384)、PG_CONTAINER
...
- `run_eval.py` — dense/sparse/hybrid 三路 → nDCG@k/Recall@k/MRR
- `common.py` — tokenize(复现 app) / embedding / docker-psql / 向量字面量
